...
Pose3d ComputeCameraPoseEpnp(const Array<Vector3d> &points3,
                             ...
                             const Vector2d focal, const Vector2d principal);
 ...
 * */
std::vector<PoseHypothesis> ComputeCameraPoseEpnpRansac(
    const Array<Vector3d> &points3, const Array<Vector2d> &points2,
    const Vector2d focal, const Vector2d principal,
    const uint32_t numExperiments, const double ransacThreshold,
...
Pose3d ComputeCameraPoseIterativePnp(const Array<Vector3d> &points3,
                                     const Array<Vector2d> &points2,
                                     const Vector2d focal, const Vector2d principal,
                                     const Pose3d& initialGuess, size_t iterations = 5);
} // namespace vision3d
} // namespace cvcore
